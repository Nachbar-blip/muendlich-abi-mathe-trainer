...
URL = "https://nachbar-blip.github.io/muendlich-abi-mathe-trainer/"
OUT = ROOT / "QR Muendlich-Abi Mathe Trainer.docx"
...
h = doc.add_heading("Mündlich-Abi Mathe — Trainer", level=0)
h.alignment = WD_ALIGN_PARAGRAPH.CENTER

p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
r = p.add_run("Üben für die mündliche Mathe-Prüfung: Analysis & Analytische Geometrie")
r.italic = True
r.font.size = Pt(12)
