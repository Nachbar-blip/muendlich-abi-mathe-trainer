...
TOPIC_ORDER = [
    "ana-symmetrie", "ana-nullstellen", "ana-extrema", "ana-ableitung-graph",
    "ana-integral", "geo-vektoren", "geo-ebene", "geo-lage-abstand",
    "geo-spiegelung", "geo-dreieck",
]

# mc-Items mit check art=ausdruck ohne eigene loesung -> verifizierter Vergleichswert.
ERWARTET_PATCH = {
    "ana-symmetrie-r4": 0,        # f(-3)+f(3) == 0  (Punktsymmetrie)
    "ana-integral-r5": "32/3",    # Flaecheninhalt = 32/3
}
